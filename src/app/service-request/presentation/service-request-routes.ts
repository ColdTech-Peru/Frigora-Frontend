    ...
    children: [
      {
        path: '',
        loadComponent: () =>
          import('./views/service-request-list/service-request-list')
      ...
      },
      {
        path: 'new',
        loadComponent: () =>
          import('./views/service-request-new/service-request-new')
            .then(m => m.ServiceRequestNewComponent),
        data: { titleKey: 'services.requests.new', roleRequired: 'owner' }
      },
      {
        path: ':requestId',
        loadComponent: () =>
          import('./views/service-request-detail/service-request-detail')
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./views/intervention-detail/intervention-detail')
            .then(m => m.InterventionDetailComponent),
        data: { titleKey: 'services.intervention.detail'}
      }
    ]
  }
];
